...
const About = () => {
  return (
    <div className='py-5 min-vh-100 about-section'>
        ...
        {/* the left part */}
            <div className='col-md-5 pt-3 text-center text-md-start'>
                ...
                <p className='lead my-4 text-muted'> A frontend developer based in Nairobi Kenya. I have worked on a range of front-end projects, <br />
